...
source_1_static = ColumnDataSource(
    data=dict(
        step=[],
        t1=[],
        t1_e=[],
...
t1 = "r1"
data_1 = get_data(t1)
source_1.data = source_1.from_df(
    data_1[
        [
            "t1",
            "t1_e",
...
if pyfrag_sign == False:
    ...
    p1.line(
        PYFRAG["bondlength"], PYFRAG["straintotal"], color="red", legend="ΔE_strain"
    )
    ...
    layout = column(
        main_row, series, gridplot([[p1, p2]], plot_width=500, plot_height=500)
    )
