...
class ADF_Result(Result):
    ...
    def __init__(
        self, settings, molecule, job_name, path_t21, plams_dir=None, status="done"
    ):
    ...
    def from_dict(cls, settings, molecule, job_name, archive, status):
        ...
        return ADF_Result(settings, molecule, job_name, path_t21, plams_dir, status)
...
class DFTB(Package):
    ...
    def run_job(settings, mol, job_name="DFTBjob"):
        ...
        return DFTB_Result(
            dftb_settings, mol, result.job.name, plams_dir=result.job.path
        )
...
class DFTB_Result(Result):
    ...
    def __init__(self, settings, molecule, job_name, plams_dir=None, status="done"):
    ...
    def from_dict(cls, settings, molecule, job_name, archive, status):
        return DFTB_Result(
            settings, molecule, job_name, archive["plams_dir"].path, status
        )
