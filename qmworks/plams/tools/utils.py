...
class Units(object):
    ...
    constants[
        "bohr_radius"
    ] = 0.52917721067  # http://physics.nist.gov/cgi-bin/cuu/Value?bohrrada0
    constants[
        "avogadro_constant"
    ] = 6.022140857e23  # http://physics.nist.gov/cgi-bin/cuu/Value?na
    constants[
        "speed_of_light"
    ] = 299792458  # http://physics.nist.gov/cgi-bin/cuu/Value?c
    constants[
        "electron_charge"
    ] = 1.6021766208e-19  # http://physics.nist.gov/cgi-bin/cuu/Value?e
    ...
    energy["ev"] = energy["eV"]
    energy["kJ/mol"] = (
        4.359744650e-21 * constants["NA"]
    )  # http://physics.nist.gov/cgi-bin/cuu/Value?hrj
