...
# -*- coding: utf-8 -*-
#
# PyFrag documentation build configuration file, created by
...
latex_documents = [
    (master_doc, "PyFrag.tex", "PyFrag Documentation", "X. Sun", "manual"),
]
...
man_pages = [(master_doc, "PyFrag", "PyFrag Documentation", [author], 1)]
...
rst_epilog = """
.. |Package| replace:: :class:`~PyFrag.packages.Package`
